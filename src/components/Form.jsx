...
export default function Form() {
    return (
        <div className="relative z-[1] w-[80%] mx-auto py-10">
            <h1 className=" text-[40px] text-white font-semibold mb-[40px]">Leave <span className=" text-main-0">Money Problem </span>to us
                and <span className="text-main-0">just focus on your Business</span></h1>

            <div className=" bg-[#00008b] p-[25px] w-full flex flex-col justify-start items-start">
                ...
                <form action="" className="flex flex-col items-start gap-[15px] w-full">
                    ...
                    <textarea name="" id="" cols="30" rows="4" placeholder="Message" className="bg-white py-[5px] px-[10px]"></textarea>
